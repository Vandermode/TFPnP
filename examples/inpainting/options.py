...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--env_batch', default=6, type=int, help='concurrent environment number')
        self.parser.add_argument('--tau', default=0.001, type=float, help='moving average for target network')
        self.parser.add_argument('--max_step', default=20, type=int, help='max length for episode')

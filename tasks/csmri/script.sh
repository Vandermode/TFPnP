...
CUDA_VISIBLE_DEVICES=2 python -W ignore main.py --solver admm --exp test -rs 15000 --max_episode_step 6 --action_pack 5 --eval -r ./checkpoints/csmri_admm_5x6_48_1gpu/actor_0015000.pkl

...
class CTEnv(PnPEnv):
    ...
    ob_base_dim = 4
    def __init__(self, data_loader, solver, max_episode_step, device, data_transformer=None):        
        super().__init__(data_loader, solver, max_episode_step, device, data_transformer)

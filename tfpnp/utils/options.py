...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--train_iters', default=15000, type=int, help='number of train iters')
        self.parser.add_argument('--eval_per_episode', default=50, type=int, help='how many episodes to perform a validation')

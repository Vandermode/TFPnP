...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--epochs', default=50, type=int, help='number of epochs for training')
        ...
        self.parser.add_argument('--num_workers', default=4, type=int, help='number of workers on dataloader')        
